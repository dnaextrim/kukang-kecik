        ...
        <div id="page-wrapper" class="content-wrapper">
            ...
            <div class="content">
	            ...
	            <div class="page-header">
		            ...
		            <div id="form_box">
		                <form id="form_data" class="well form-horizontal" role="form" data-async method="post" action="<?php $url->to("contact/insert") ?>" enctype="multipart/form-data">
		                    <fieldset id="form_fieldset">
			                    <div class="form-group">
			                        <label class="col-sm-3 control-label no-padding-right" for="Name">Nama</label>
			                        <div class="col-sm-3">
			                            <input type="text" id="Name" name="Name" required class="form-data form-control" max-length="255" value="" />
			                        </div>
			                    </div>
			                    
			                    <div class="form-group">
			                        <label class="col-sm-3 control-label no-padding-right" for="Number">No. HP</label>
			                        <div class="col-sm-3">
			                            <input type="text" id="Number" name="Number" required class="form-data form-control" max-length="255" value="" />
			                        </div>
			                    </div>

			                    <div class="form-group">
			                        <label class="col-sm-3 control-label no-padding-right" for="GroupID">Kelompok</label>
			                        <div class="col-sm-3">
			                            <select id="GroupID" name="GroupID" required class="select2 form-data" style="width: 100%">
			                                <option>&nbsp;</option>
			                                <?php 
				            ...
				            <div class="modal-body">
				                ...
				                <div class="well form-horizontal">
				                    <div class="form-group">
				                        <label class="col-sm-3 control-label no-padding-right" for="Name">Nama</label>
				                        <div class="col-sm-9">
				                            <p id="Name" class="form-view form-control-static"></p>
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <label class="col-sm-3 control-label no-padding-right" for="Number">No. HP</label>
				                        <div class="col-sm-9">
				                            <p id="Number" class="form-view form-control-static" ></p>
				                        </div>
				                    </div>
				                    <div class="form-group">
				                        <label class="col-sm-3 control-label no-padding-right" for="GroupName">Kelompok</label>
				                        <div class="col-sm-9">
				                            <p id="GroupName" class="form-view form-control-static"></p>
				                        </div>
				                    </div>
