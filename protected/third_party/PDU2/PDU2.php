...
class PDU2 {
	...
	public function destination_address($telephone) {
	...
	public function data_coding_scheme() {
	...
	public function validity_period($expiry_sec=false) {
	...
	public function user_data_length($message) {
